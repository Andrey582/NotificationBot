...
public class ChatToLink extends TableImpl<ChatToLinkRecord> {
     ...
     */
    public final TableField<ChatToLinkRecord, Long> CHAT_ID = createField(DSL.name("CHAT_ID"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>CHAT_TO_LINK.LINK_ID</code>.
     */
    public final TableField<ChatToLinkRecord, Long> LINK_ID = createField(DSL.name("LINK_ID"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>CHAT_TO_LINK.NAME</code>.
     */
    public final TableField<ChatToLinkRecord, String> NAME = createField(DSL.name("NAME"), SQLDataType.VARCHAR(1000000000), this, "");
    ...
    @Override
    @NotNull
    public List<UniqueKey<ChatToLinkRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.CONSTRAINT_533, Keys.CONSTRAINT_5330);
    }
