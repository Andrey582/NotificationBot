...
public class ChatRecord extends UpdatableRecordImpl<ChatRecord> implements Record2<Long, Long> {
    ...
    public Field<Long> field1() {
        return edu.java.database.jooq.tables.Chat.CHAT.ID;
    }

    @Override
    @NotNull
    public Field<Long> field2() {
        return edu.java.database.jooq.tables.Chat.CHAT.CHAT_ID;
    }
     ...
     */
    public ChatRecord() {
        super(edu.java.database.jooq.tables.Chat.CHAT);
    }
    ...
    public ChatRecord(@Nullable Long id, @NotNull Long chatId) {
        super(edu.java.database.jooq.tables.Chat.CHAT);
