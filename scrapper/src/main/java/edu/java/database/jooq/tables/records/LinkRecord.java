...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record3<Long, String, OffsetDateTime> {
    ...
    public Field<Long> field1() {
        return edu.java.database.jooq.tables.Link.LINK.ID;
    }

    @Override
    @NotNull
    public Field<String> field2() {
        return edu.java.database.jooq.tables.Link.LINK.LINK_URL;
    }

    @Override
    @NotNull
    public Field<OffsetDateTime> field3() {
        return edu.java.database.jooq.tables.Link.LINK.LAST_CHECK_TIME;
    }
     ...
     */
    public LinkRecord() {
        super(edu.java.database.jooq.tables.Link.LINK);
    }
    ...
    public LinkRecord(@Nullable Long id, @NotNull String linkUrl, @NotNull OffsetDateTime lastCheckTime) {
        super(edu.java.database.jooq.tables.Link.LINK);
